<div class=" col-md-4 offset-md-2">
        <form class="my-2 p-3 border" method="POST" >
            ...
            <div class="form-group">
                ...
                <input type="text" name="adress" class="form-control" id="exampleInputName1" >
            </div>
            <div class="form-group">
                <label for="exampleInputName1"> <?=$image?></label>
                <input type="text" name="image" class="form-control" id="exampleInputName1" >
            </div>
            <div class="form-group">
                <label for="exampleInputName1"> <?=$cover?></label>
                <input type="text" name="cover" class="form-control" id="exampleInputName1" >
            </div>
